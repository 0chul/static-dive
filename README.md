...
- 프로젝트 페이지: https://0chul.github.io/static-dive/
- API 입력란에 백엔드 주소를 적어야 실제 데이터를 불러옵니다. 예) `https://example.com` 혹은 로컬 개발 시 `http://localhost:8000`.
- 기본값은 현재 호스트 기준이며, API가 없을 경우 화면에 오류 카드가 표시됩니다.
